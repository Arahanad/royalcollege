...
class ROYALCOLLAGE():
    ...
    def __init__(self, url):
        self.url = url
        self.cookies = {
            'JSESSIONID': 'uC6rqmj9aaQf3IH-QOxnKxwAZTgu4yl5zKT9sgYy_O3qgM05HNmu!-1815329270',
            '_gid': 'GA1.2.828264456.1695029971',
            'oracle.adf.view.rich.automation.ENABLED': 'FULL',
            'LOGIN_NLS': 'en',
            '_ga_3PP85V2VM8': 'GS1.1.1695097189.5.0.1695097189.0.0.0',
            '_ga': 'GA1.2.1061590782.1694595589',
        ...
        self.headers = {
            ...
            # 'Cookie': 'JSESSIONID=uC6rqmj9aaQf3IH-QOxnKxwAZTgu4yl5zKT9sgYy_O3qgM05HNmu!-1815329270; _gid=GA1.2.828264456.1695029971; oracle.adf.view.rich.automation.ENABLED=FULL; LOGIN_NLS=en; _ga_3PP85V2VM8=GS1.1.1695097189.5.0.1695097189.0.0.0; _ga=GA1.2.1061590782.1694595589; _gat_gtag_UA_29215260_1=1',
        ...
        self.params = {
            'Adf-Window-Id': 'w13pp2mgzym',
            'Adf-Page-Id': '0',
            '_afrECID': '0061QuIPyssApIYjLpINOA0003cg0001wo',
        }
    ...
    def scrape_page(self, start, end):
        data = f"wc.contextURL=%2Fspaces%2Frcdirectory_en&T:j_idt4:wcs_previouslySetPageTemplate=gsr5194f25d_51f5_4f30_a4fd_3ba3b8403962&T:dclay:oc_1588338513reijia1:sf1:inputText1=&T:dclay:oc_1588338513reijia1:sf1:selectOneChoice1=0&T:dclay:oc_1588338513reijia1:sf1:selectOneChoice2=0&T:dclay:oc_1588338513reijia1:sf1:selectOneChoice3=0&T:dclay:oc_1588338513reijia1:sf1:inputText2=&org.apache.myfaces.trinidad.faces.FORM=f1&Adf-Window-Id=w13pp2mgzym&Adf-Page-Id=0&javax.faces.ViewState=!12ycrv9lew&oracle.adf.view.rich.RENDER=T%3Adclay%3Aoc_1588338513reijia1%3Asf1%3ARCDSearchResultWideTable&oracle.adf.view.rich.monitoring.UserActivityInfo=%3Cm+xmlns%3D%22http%3A%2F%2Foracle.com%2FrichClient%2Fcomm%22%3E%3Ck+v%3D%22pr0%22%3E%3Cm%3E%3Ck+v%3D%22cid%22%3E%3Cs%3E0061QuXLBllApIYjLpINOA0003cg00020P%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22cst%22%3E%3Cs%3E1695097446408%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22cet%22%3E%3Cs%3E1695097448216%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22rrt%22%3E%3Cs%3E1695097448119%3C%2Fs%3E%3C%2Fk%3E%3C%2Fm%3E%3C%2Fk%3E%3Ck+v%3D%22prm%22%3E%3Cm%3E%3Ck+v%3D%22cst%22%3E%3Cs%3E1695097451497%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22eif%22%3E%3Cm%3E%3Ck+v%3D%22ety%22%3E%3Cs%3ErangeChange%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22cld%22%3E%3Cs%3ET%3Adclay%3Aoc_1588338513reijia1%3Asf1%3ARCDSearchResultWideTable%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22cty%22%3E%3Cs%3Eoracle.adf.RichTable%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22rvd%22%3E%3Cs%3E%2FrcdirectoryTF%2FadvancedSearch%3C%2Fs%3E%3C%2Fk%3E%3C%2Fm%3E%3C%2Fk%3E%3Ck+v%3D%22ppr%22%3E%3Cs%3ET%3Adclay%3Aoc_1588338513reijia1%3Asf1%3ARCDSearchResultWideTable%3C%2Fs%3E%3C%2Fk%3E%3C%2Fm%3E%3C%2Fk%3E%3C%2Fm%3E&event=T%3Adclay%3Aoc_1588338513reijia1%3Asf1%3ARCDSearchResultWideTable&event.T:dclay:oc_1588338513reijia1:sf1:RCDSearchResultWideTable=%3Cm+xmlns%3D%22http%3A%2F%2Foracle.com%2FrichClient%2Fcomm%22%3E%3Ck+v%3D%22oldStart%22%3E%3Cs%3E39300%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22oldEnd%22%3E%3Cs%3E39319%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22newStart%22%3E%3Cs%3E{start}%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22newEnd%22%3E%3Cs%3E3{end}%3C%2Fs%3E%3C%2Fk%3E%3Ck+v%3D%22type%22%3E%3Cs%3ErangeChange%3C%2Fs%3E%3C%2Fk%3E%3C%2Fm%3E&oracle.adf.view.rich.PROCESS=T%3Adclay%3Aoc_1588338513reijia1%3Asf1%3ARCDSearchResultWideTable"
        while True:
